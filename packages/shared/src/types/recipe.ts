...
export const RecipeIngredient = Companion(
  "RecipeIngredient",
  type({
...
export const SectionItem = ScopedCompanion(section, "SectionItem") satisfies AnyCompanion<{
...
export const RecipeVersion = Companion(
  "RecipeVersion",
  type({
