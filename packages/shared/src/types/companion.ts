 ...
 */
export interface Companion<N extends string, T extends Type> {
  readonly name: N
  readonly type: T
}
 ...
 */
export function Companion<N extends string, T extends Type, R extends Companion<N, T> = Companion<N, T>>(name: N, type: T, extend?: (o: Companion<N, T>) => R): R {
