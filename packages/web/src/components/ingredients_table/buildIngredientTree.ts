...
import { Companion, IngredientId, Measurement, ScopedCompanion } from "@recipe-book/shared";
...
export type IngredientRow = Simplify<
  ReadonlyDeep<Omit<typeof IngredientRow.type.infer, "subRows">> & {
